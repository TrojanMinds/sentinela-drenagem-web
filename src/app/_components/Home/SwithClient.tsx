...
function HomeCard({
  ...
  return (
    <div
      className={`relative flex h-[75vh] w-[70%] items-center justify-between ${i % 2 == 1 && "flex-row-reverse"}`}
    >
      <div className="relative h-[80%] w-[55%]">
      ...
      <Image
        ...
        width={1000}
        height={1000}
        className="h-[90%] w-[40%] rounded-sm object-cover"
      />
    </div>
  );
}
...
const DataForSelected: DataSelection[][] = [
  ...
  [],
  [{title: "test", subtitle: "ggg", imagePath: "",
    html: (
        Sistema()
  )}],
  [],
...
function SwithClient() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-BG px-4 overflow-x-hidden">
      ...
      <Image
        ...
        height={5000}
        alt="background"
        className="w- absolute top-0 object-contain"
      />
      ...
      <div className="absolute bottom-[-30%] h-[100vh] w-full bg-gradient-to-b from-transparent to-BG" />
